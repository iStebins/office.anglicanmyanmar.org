...
<section class="section dashboard">
    <div class="d-flex justify-content-center">
        ...
        <div class="col-lg-8 col-sm-12">
            <div class="card">
                <img src="{{ $new->image ? asset("images/$new->image") : asset("assets/img/logo.png") }}" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">{{ $new->title }}</h5>
                    <p class="card-text"> <i class="bx bxs-calendar"></i> {{ $new->created_at }} <span class="badge rounded-pill bg-primary">{{ $new->diocese->name }}</span></p>
                    <p class="card-text">{!! $new->paragraph !!} </p>
                    <div class="d-flex justify-content-around">
                        <a href="{{ route('news.index') }}" class="btn btn-primary"><i class="ri-arrow-go-back-fill"></i> Back</a>

                        <a href="{{ route('news.edit',$new->id) }}" class="btn btn-warning"><i class="ri-edit-box-line"></i> Edit</a>
